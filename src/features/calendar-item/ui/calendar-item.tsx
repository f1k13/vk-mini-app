...
const CalendarItem = ({ item }: { item: CalendarData }) => {
  ...
  return (
    <div className="flex flex-col w-full justify-center  items-center text-16px transition-colors duration-300 max-[400px]:text-12px cursor-pointer hover:bg-blockSecondaryColor">
